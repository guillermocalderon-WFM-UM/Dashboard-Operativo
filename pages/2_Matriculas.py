...
<div class='wip'>
    ...
    <div class='wip-title'>Matrículas</div>
    <div class='wip-sub'>
        Este módulo está en construcción. Aquí vivirá el seguimiento de matriculados por período,
        programa, paquete inscrito, tipo de admisión y estatus del alumno — a partir de la hoja
        "Cambios" una vez definamos su alcance.
    </div>
</div>
""", unsafe_allow_html=True)
