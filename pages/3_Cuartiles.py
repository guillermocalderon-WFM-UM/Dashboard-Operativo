...
<div class='wip'>
    ...
    <div class='wip-title'>Cuartiles</div>
    <div class='wip-sub'>
        Este módulo está en construcción. Aquí vivirá la clasificación de asesores por cuartil
        de desempeño, el comparativo entre supervisores y la evolución histórica por período.
    </div>
</div>
""", unsafe_allow_html=True)
